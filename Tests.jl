...
weinberg2D_wrap(Positions, Data_dir*"Test_np_1",periodic=false,r=1)
weinberg2D_wrap(Positions, Data_dir*"Test_p_1",periodic=true,r=1)
...
compute_flip_graph(code_amalg,network_save_str,r=1)
